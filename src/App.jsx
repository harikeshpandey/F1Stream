...
const Header = () => (
    <motion.header 
        ...
        className="w-full bg-black bg-opacity-80 backdrop-blur-sm p-4 fixed top-0 left-0 z-50 border-b border-gray-800"
    >
        <div className="container mx-auto h-auto flex justify-between items-center">
            <F1Logo />
            <a href='https://github.com/harikeshpandey'>
            <motion.button 
                className="bg-red-600 text-white font-bold py-2 px-5 rounded-md text-sm hover:bg-red-700 transition-colors"
...
const VideoPlayer = ({ embedUrl }) => (
    <motion.div 
        ...
        className="aspect-video w-full max-w-6xl mx-auto bg-black rounded-lg overflow-hidden shadow-2xl shadow-red-500/10 border-2 border-gray-800"
    >
        <iframe
            src={embedUrl}
...
const RaceInfo = () => (
    ...
    >
        ...
        <h1 className="text-4xl md:text-5xl font-extrabold text-white uppercase">Formula 1 US Grand Prix</h1>
